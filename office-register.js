(() => {
  if (!window.icons || !window.apps || !window.desktopIcons || !window.pinGrid) return;
  ...
  apps.docs = {title:'WDM Docs',label:'Docs',url:'https://wdmapps.com.br/office/?app=docs',icon:'docs',mode:'iframe'};
